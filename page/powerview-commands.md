...
Get-DomainOU -GPLink '\<GPP\_GUID>' | % {Get-DomainComputer -SearchBase $\_.distinguishedname -Properties dnshostname}
...
Get-DomainUser -UACFilter NOT\_ACCOUNTDISABLE -Properties distinguishedname
...
Get-DomainUser -UACFilter SMARTCARD\_REQUIRED
...
Get-DomainUser -UACFilter NOT\_SMARTCARD\_REQUIRED -Properties samaccountname
...
Get-DomainUser -UACFilter DONT\_REQ\_PREAUTH
...
Get-DomainGPOUserLocalGroupMapping | %{$\_.computers = $\_.computers -join ", "; $\_} | Export-CSV -NoTypeInformation gpo\_map.csv
